<template>
    ...
    <div class="fixed bottom-6 right-6 z-50">
        ...
        >
            ...
            <!-- Tooltip -->
            <span class="absolute right-16 bg-advocacia-azul-principal text-white px-3 py-2 rounded-lg text-sm whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
